...
export const GetCode = ({ name, description, onClose, classes }) => {
  return (
    <>
    
      <div
        className={"absolute w-80 rounded-2xl block border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8 " + classes}
        role="alert"
      >
        <div className="flex items-center gap-4">
          ...
          <p className="font-medium sm:text-lg">Get a {name} Code!</p>
        </div>
