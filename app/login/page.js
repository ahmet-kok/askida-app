...
export default function Login() {
  ...
  const createUser = async (event) => {
    ...
    if (
      ...
      await fetch("https://askida-kod.onrender.com/api/public/register", {
        body: body,
        headers: {
        ...
        .then((result) => {
          ...
          if (result.status == 200) {
            ...
            alert(
              "An error occured, please contact with us via support email."
            );
          }
        });
    } else {
  ...
  const loginUser = async (event) => {
    ...
    await fetch("https://askida-kod.onrender.com/api/public/login", {
      body: body,
      headers: {
        "Content-Type": "application/json",
      },
              ...
              <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
                <div className="max-w-xl lg:max-w-3xl">
                  ...
                  <div className="mt-5 flex items-center justify-center ">
                    <p className=" lg:w-max text-md text-gray-700 inline-flex">
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="col-span-6 flex items-center gap-4">
                          <button
                            type="submit"
                            className="transition-all justify-center w-full shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500"
                          >
                            Create an account
                            {loader && (
                              <svg
                                aria-hidden="true"
                                className="w-5 h-5 float-right text-white animate-spin fill-gray-600"
                                viewBox="0 0 100 101"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                              >
